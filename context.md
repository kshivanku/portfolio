...
- Contact footer follows the resume with a top border and large centered email link using the same drop-in letter animation as the hero heading; the Contact nav item scrolls to this footer
...
- Top-left menu icon is hidden on the hero, visible from projects through the resume/contact area, opens a full-screen menu overlay with Work, Resume, LinkedIn, and Contact links, and morphs into an X while open; tapping it or pressing Escape closes the overlay
...
*Last updated: Centered and animated the contact footer email.*
