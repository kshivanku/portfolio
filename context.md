...
- Contact footer is inside the resume section, after education, but outside the constrained resume content wrapper; it spans the full viewport with a top border, large centered email link whose letter animation triggers on viewport entry, and a social button row for LinkedIn, Instagram, GitHub, and X; the Contact nav item scrolls to this footer
...
- Top-left menu icon is hidden on the hero, visible from projects through the resume/contact area, opens a full-screen menu overlay with Work, Resume, and Contact links, and morphs into an X while open; tapping it or pressing Escape closes the overlay
...
*Last updated: Triggered contact email letter animation when the footer enters view.*
