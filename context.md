...
- Contact footer is inside the resume section, after education, with a top border, large centered animated email link, and LinkedIn button; the Contact nav item scrolls to this footer
...
*Last updated: Moved LinkedIn to the contact footer and folded contact into the resume scroll.*
