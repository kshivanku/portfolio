...
- Top-left menu icon is hidden on the hero, visible from projects through the resume/contact area, opens a full-screen menu overlay with Work, Play, Resume, and Contact links, and morphs into an X while open; Play opens `https://kshivanku.github.io/play/` in a new tab; the overlay fades smoothly and each link uses a GSAP masked reveal with slight stagger; tapping it or pressing Escape closes the overlay
...
*Last updated: Updated Play navigation link to the play page.*
