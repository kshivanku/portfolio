...
- Top-left menu icon is hidden on the hero, visible from projects through resume, opens a full-screen menu overlay with Work, Resume, and LinkedIn links, and morphs into an X while open; tapping it or pressing Escape closes the overlay
...
*Last updated: Center-aligned carousel indicator numbers and dots with equal vertical spacing.*
