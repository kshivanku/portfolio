...
| # | Frame | Content |
|---|--------|---------|
| 1 | **Hero** | Small greeting with animated wave + large product design statement |
...
*Last updated: Added a Google Drive download link to the resume section.*
